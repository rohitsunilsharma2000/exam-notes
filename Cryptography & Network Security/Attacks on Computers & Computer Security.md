...
| **Characteristic**         | **Active Attacks**                                                                                                                                                                                                                                                                                         | **Passive Attacks**                                                                                                                                                                                                                                                                                     |
|----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Basic Definition**       | **English:** Active attacks involve direct interference with network communications by modifying, injecting, or disrupting data. <br> **Bengali (Burdwan style):** অ্যাকটিভ আক্রমণ মানে সরাসরি নেটওয়ার্ক যোগাযোগে হস্তক্ষেপ করে ডেটা বদলানো, ঢোকানো বা ব্যাঘাত ঘটানো।                                              | **English:** Passive attacks involve eavesdropping or monitoring communications without altering them. <br> **Bengali (Burdwan style):** প্যাসিভ আক্রমণ মানে ডেটা পরিবর্তন না করে শুধু শুনে বা নজরদারি করা।                                                                      |
| **Nature of Interference** | **English:** They actively change the content or flow of information, which can result in data corruption or loss. <br> **Bengali (Burdwan style):** এগুলো সরাসরি তথ্যের কন্টেন্ট বা ফ্লো বদলে দেয়, যা ডেটা ক্ষতি বা হারানোর কারণ হতে পারে।                                                         | **English:** They only observe and record the data, leaving the original content intact. <br> **Bengali (Burdwan style):** এগুলো শুধু তথ্য শোনে ও রেকর্ড করে, মূল তথ্য অপরিবর্তিত রাখে।                                                                                              |
| **Additional Point 1**     | **English:** Active attacks are often more noticeable and easier to detect because of the disturbances they cause. <br> **Bengali (Burdwan style):** অ্যাকটিভ আক্রমণগুলো সহজে ধরা পড়ে কারণ এগুলো যোগাযোগে স্পষ্ট বিঘ্ন সৃষ্টি করে।                                                              | **English:** Passive attacks are stealthy and difficult to detect since they do not disrupt normal operations. <br> **Bengali (Burdwan style):** প্যাসিভ আক্রমণগুলো চুপচাপ হয় ও ধরা পড়তে কঠিন, কারণ এগুলো সাধারণ যোগাযোগে কোনো বিঘ্ন সৃষ্টি করে না।                                            |
| **Additional Point 2**     | **English:** They can lead to immediate consequences such as data loss, service disruption, or unauthorized modifications. <br> **Bengali (Burdwan style):** এগুলো তৎক্ষণাৎ ফলাফল দেয়, যেমন ডেটা হারানো, সার্ভিস বন্ধ হয়ে যাওয়া বা অননুমোদিত পরিবর্তন।                                                | **English:** They primarily threaten privacy and data confidentiality without directly affecting service availability. <br> **Bengali (Burdwan style):** এগুলো মূলত প্রাইভেসি ও ডেটা গোপনীয়তার হুমকি সৃষ্টি করে, সরাসরি সার্ভিসে বিঘ্ন ঘটায় না।                                                |
